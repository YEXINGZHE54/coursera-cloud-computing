...
public class RankAirportByDep extends Mapper<LongWritable, Text,Text,DoubleWritable> {
    public static final Log log = LogFactory.getLog(RankAirportByDep.class);
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(RankAirportByDep.class);
        job.setMapperClass(RankAirportByDep.class);
